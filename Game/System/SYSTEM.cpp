...
void SYSTEM::menu()
{
	while(domenu)
	{
		...
		if (location == "Hel")
			cout << "(7) Check team " << "               (8) Sleep        (9) Holy war\n";
		else 
...
void SYSTEM::holywar() {
	while (playername == "")
	{
		system("cls");
		string newname;
		cout << "The holywar is online game, you need a nickname." << endl;
		cout << "Please type your nickname: " << endl;
		cin >> newname;
		if (newname.length() > 12)
		{
			system("cls");
			cout << "The nickname cannot be more than 12 characters!" << endl;
			system("pause");
		}
		else
			playername = newname;
	...
	connection online(playername, pler);
}
